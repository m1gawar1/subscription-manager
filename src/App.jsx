  ...
  const [subscriptions, setSubscriptions] = useState(() => {
    ...
    return data.map(sub => {
      ...
      if (!newSub.domain) {
        ...
        else if (normalizedName.includes('dアニメ') || normalizedName.includes('d anime')) newSub.domain = 'https://logo.clearbit.com/nttdocomo.co.jp';
        else if (normalizedName.includes('dマガジン') || normalizedName.includes('d magazine')) newSub.domain = 'https://logo.clearbit.com/nttdocomo.co.jp';
      }
